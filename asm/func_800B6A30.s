...
.section .text, "ax" # 800B6A30


.global func_800B6A30
func_800B6A30:
...
/* 800B6A40 000B3980  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 800B6A44 000B3984  39 61 00 50 */	addi r11, r1, 0x50
/* 800B6A48 000B3988  48 2A B7 95 */	bl func_803621DC
/* 800B6A4C 000B398C  7C 7E 1B 78 */	mr r30, r3
/* 800B6A50 000B3990  4B FF 98 6D */	bl func_800B02BC
...
/* 800B6AB0 000B39F0  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800B6AB4 000B39F4  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800B6AC8 000B3A08  4B FB 8F 5D */	bl func_8006FA24
...
/* 800B6AE0 000B3A20  48 07 EC 11 */	bl func_801356F0
/* 800B6AE4 000B3A24  48 00 04 24 */	b lbl_800B6F08
.global lbl_800B6AE8
lbl_800B6AE8:
/* 800B6AE8 000B3A28  7F C3 F3 78 */	mr r3, r30
/* 800B6AEC 000B3A2C  48 04 3F 91 */	bl func_800FAA7C
...
/* 800B6B10 000B3A50  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800B6B14 000B3A54  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800B6B28 000B3A68  4B FB 8E FD */	bl func_8006FA24
/* 800B6B2C 000B3A6C  7F C3 F3 78 */	mr r3, r30
/* 800B6B30 000B3A70  48 04 52 D5 */	bl func_800FBE04
...
/* 800B6B70 000B3AB0  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800B6B74 000B3AB4  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800B6B88 000B3AC8  4B FB 8E 9D */	bl func_8006FA24
/* 800B6B8C 000B3ACC  7F C3 F3 78 */	mr r3, r30
/* 800B6B90 000B3AD0  48 04 86 FD */	bl func_800FF28C
...
/* 800B6BA4 000B3AE4  48 04 63 B5 */	bl func_800FCF58
...
/* 800B6BE8 000B3B28  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800B6BEC 000B3B2C  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800B6C00 000B3B40  4B FB 8E 25 */	bl func_8006FA24
...
/* 800B6C30 000B3B70  48 04 6B F5 */	bl func_800FD824
...
/* 800B6C48 000B3B88  48 04 71 49 */	bl func_800FDD90
...
/* 800B6C64 000B3BA4  4B F5 8B E5 */	bl func_8000F848
...
/* 800B6CC8 000B3C08  48 04 74 4D */	bl func_800FE114
...
/* 800B6CDC 000B3C1C  48 04 62 A9 */	bl func_800FCF84
...
/* 800B6D08 000B3C48  4B FE 6D 59 */	bl func_8009DA60
/* 800B6D0C 000B3C4C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 800B6D10 000B3C50  41 82 00 18 */	beq lbl_800B6D28
/* 800B6D14 000B3C54  3C 60 80 11 */	lis r3, lbl_80110654@ha
/* 800B6D18 000B3C58  38 63 06 54 */	addi r3, r3, lbl_80110654@l
/* 800B6D1C 000B3C5C  38 80 00 00 */	li r4, 0
/* 800B6D20 000B3C60  4B F6 2A D9 */	bl func_800197F8
...
/* 800B6D30 000B3C70  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800B6D34 000B3C74  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800B6D4C 000B3C8C  4B F6 3C 19 */	bl func_8001A964
...
/* 800B6D84 000B3CC4  4B F7 45 25 */	bl func_8002B2A8
/* 800B6D88 000B3CC8  2C 03 00 00 */	cmpwi r3, 0
/* 800B6D8C 000B3CCC  41 82 00 1C */	beq lbl_800B6DA8
/* 800B6D90 000B3CD0  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800B6D94 000B3CD4  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800B6DD0 000B3D10  48 04 6B FD */	bl func_800FD9CC
...
/* 800B6DE8 000B3D28  48 00 C5 D1 */	bl func_800C33B8
...
/* 800B6E08 000B3D48  4B FF C6 8D */	bl func_800B3494
...
/* 800B6E54 000B3D94  48 07 85 C9 */	bl func_8012F41C
/* 800B6E58 000B3D98  48 00 00 B0 */	b lbl_800B6F08
.global lbl_800B6E5C
lbl_800B6E5C:
/* 800B6E5C 000B3D9C  7F C3 F3 78 */	mr r3, r30
/* 800B6E60 000B3DA0  48 01 06 75 */	bl func_800C74D4
...
/* 800B6EC8 000B3E08  48 07 E8 29 */	bl func_801356F0
/* 800B6ECC 000B3E0C  48 00 00 3C */	b lbl_800B6F08
.global lbl_800B6ED0
lbl_800B6ED0:
/* 800B6ED0 000B3E10  7F C3 F3 78 */	mr r3, r30
/* 800B6ED4 000B3E14  48 07 E7 19 */	bl func_801355EC
...
/* 800B6EE8 000B3E28  48 04 4F 1D */	bl func_800FBE04
/* 800B6EEC 000B3E2C  48 00 00 1C */	b lbl_800B6F08
.global lbl_800B6EF0
lbl_800B6EF0:
/* 800B6EF0 000B3E30  7F C3 F3 78 */	mr r3, r30
/* 800B6EF4 000B3E34  48 04 52 85 */	bl func_800FC178
...
.global lbl_800B6F08
lbl_800B6F08:
/* 800B6F08 000B3E48  E3 E1 00 58 */	psq_l f31, 88(r1), 0, qr0
/* 800B6F0C 000B3E4C  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 800B6F10 000B3E50  39 61 00 50 */	addi r11, r1, 0x50
/* 800B6F14 000B3E54  48 2A B3 15 */	bl func_80362228
