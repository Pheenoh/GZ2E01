...
.section .text, "ax" # 801ACD0C


.global func_801ACD0C
func_801ACD0C:
...
/* 801ACD58 001A9C98  3C 80 80 40 */	lis r4, lbl_804061C0@ha
/* 801ACD5C 001A9C9C  3B C4 61 C0 */	addi r30, r4, lbl_804061C0@l
...
/* 801ACDC8 001A9D08  48 13 1D 31 */	bl func_802DEAF8
...
/* 801ACE0C 001A9D4C  4B FF FB 0D */	bl func_801AC918
.global lbl_801ACE10
lbl_801ACE10:
...
/* 801AD124 001AA064  4B EA D9 BD */	bl func_8005AAE0
...
/* 801AD154 001AA094  48 19 9A C5 */	bl func_80346C18
...
/* 801AD17C 001AA0BC  48 19 9A 9D */	bl func_80346C18
.global lbl_801AD180
lbl_801AD180:
/* 801AD180 001AA0C0  7E 03 83 78 */	mr r3, r16
/* 801AD184 001AA0C4  38 81 01 70 */	addi r4, r1, 0x170
/* 801AD188 001AA0C8  48 17 86 0D */	bl func_80325794
...
/* 801AD19C 001AA0DC  48 17 8E 71 */	bl func_8032600C
.global lbl_801AD1A0
lbl_801AD1A0:
...
/* 801AD258 001AA198  4B FF E0 29 */	bl func_801AB280
...
/* 801AD3AC 001AA2EC  4B FF F1 D1 */	bl func_801AC57C
...
/* 801AD464 001AA3A4  4B E7 F5 19 */	bl func_8002C97C
...
/* 801AD570 001AA4B0  48 19 96 A9 */	bl func_80346C18
...
/* 801AD5AC 001AA4EC  4B E5 EF 61 */	bl func_8000C50C
...
/* 801AD5BC 001AA4FC  48 19 8F 29 */	bl func_803464E4
/* 801AD5C0 001AA500  7E 03 83 78 */	mr r3, r16
/* 801AD5C4 001AA504  38 81 01 10 */	addi r4, r1, 0x110
/* 801AD5C8 001AA508  48 17 81 CD */	bl func_80325794
...
/* 801AD6C8 001AA608  48 19 95 51 */	bl func_80346C18
...
/* 801AD704 001AA644  4B E5 EE 09 */	bl func_8000C50C
...
/* 801AD714 001AA654  48 19 8D D1 */	bl func_803464E4
/* 801AD718 001AA658  7E 03 83 78 */	mr r3, r16
/* 801AD71C 001AA65C  38 81 00 B0 */	addi r4, r1, 0xb0
/* 801AD720 001AA660  48 17 80 75 */	bl func_80325794
...
/* 801AD8CC 001AA80C  4B FF 21 3D */	bl func_8019FA08
...
/* 801AD8F8 001AA838  48 19 9A A5 */	bl func_8034739C
...
/* 801ADADC 001AAA1C  4B EA DC 85 */	bl func_8005B760
...
/* 801ADAF8 001AAA38  48 0B AD 9D */	bl func_80268894
...
/* 801ADBEC 001AAB2C  3C 80 80 1A */	lis r4, lbl_8019F438@ha
/* 801ADBF0 001AAB30  38 84 F4 38 */	addi r4, r4, lbl_8019F438@l
...
/* 801ADC04 001AAB44  3C 80 80 1A */	lis r4, lbl_8019F438@ha
/* 801ADC08 001AAB48  38 84 F4 38 */	addi r4, r4, lbl_8019F438@l
...
/* 801ADC1C 001AAB5C  3C 80 80 1A */	lis r4, lbl_8019F478@ha
/* 801ADC20 001AAB60  38 84 F4 78 */	addi r4, r4, lbl_8019F478@l
...
/* 801ADC34 001AAB74  3C 80 80 1A */	lis r4, lbl_8019F4B8@ha
/* 801ADC38 001AAB78  38 84 F4 B8 */	addi r4, r4, lbl_8019F4B8@l
...
/* 801ADC4C 001AAB8C  3C 80 80 0D */	lis r4, lbl_800CFC7C@ha
/* 801ADC50 001AAB90  38 84 FC 7C */	addi r4, r4, lbl_800CFC7C@l
...
/* 801ADC64 001AABA4  3C 80 80 0D */	lis r4, lbl_800CFC7C@ha
/* 801ADC68 001AABA8  38 84 FC 7C */	addi r4, r4, lbl_800CFC7C@l
...
/* 801ADC84 001AABC4  48 12 10 B9 */	bl func_802CED3C
.global lbl_801ADC88
lbl_801ADC88:
...
/* 801ADCC0 001AAC00  4B FF 16 29 */	bl func_8019F2E8
/* 801ADCC4 001AAC04  3C 80 80 1B */	lis r4, lbl_801ADBBC@ha
/* 801ADCC8 001AAC08  38 84 DB BC */	addi r4, r4, lbl_801ADBBC@l
...
/* 801ADCD8 001AAC18  48 11 84 45 */	bl func_802C611C
/* 801ADCDC 001AAC1C  3C 80 80 2C */	lis r4, lbl_802C6540@ha
/* 801ADCE0 001AAC20  38 84 65 40 */	addi r4, r4, lbl_802C6540@l
