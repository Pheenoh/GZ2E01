...
.section .text, "ax" # 800AC754


.global func_800AC754
func_800AC754:
...
/* 800AC764 000A96A4  F3 E1 00 A8 */	psq_st f31, 168(r1), 0, qr0
/* 800AC768 000A96A8  DB C1 00 90 */	stfd f30, 0x90(r1)
/* 800AC76C 000A96AC  F3 C1 00 98 */	psq_st f30, 152(r1), 0, qr0
/* 800AC770 000A96B0  DB A1 00 80 */	stfd f29, 0x80(r1)
/* 800AC774 000A96B4  F3 A1 00 88 */	psq_st f29, 136(r1), 0, qr0
/* 800AC778 000A96B8  DB 81 00 70 */	stfd f28, 0x70(r1)
/* 800AC77C 000A96BC  F3 81 00 78 */	psq_st f28, 120(r1), 0, qr0
/* 800AC780 000A96C0  DB 61 00 60 */	stfd f27, 0x60(r1)
/* 800AC784 000A96C4  F3 61 00 68 */	psq_st f27, 104(r1), 0, qr0
/* 800AC788 000A96C8  DB 41 00 50 */	stfd f26, 0x50(r1)
/* 800AC78C 000A96CC  F3 41 00 58 */	psq_st f26, 88(r1), 0, qr0
...
/* 800AC808 000A9748  4B FF FF 31 */	bl func_800AC738
...
/* 800AC884 000A97C4  4B FF FB 11 */	bl func_800AC394
...
/* 800AC8B8 000A97F8  4B FF FA DD */	bl func_800AC394
...
/* 800AC920 000A9860  4B FF FA 75 */	bl func_800AC394
...
/* 800AC988 000A98C8  4B FF FA 0D */	bl func_800AC394
...
/* 800AC9B4 000A98F4  48 01 28 51 */	bl func_800BF204
/* 800AC9B8 000A98F8  48 00 00 10 */	b lbl_800AC9C8
.global lbl_800AC9BC
lbl_800AC9BC:
/* 800AC9BC 000A98FC  7F 03 C3 78 */	mr r3, r24
/* 800AC9C0 000A9900  38 80 00 01 */	li r4, 1
/* 800AC9C4 000A9904  48 01 28 41 */	bl func_800BF204
.global lbl_800AC9C8
lbl_800AC9C8:
/* 800AC9C8 000A9908  9B B8 2F 8C */	stb r29, 0x2f8c(r24)
/* 800AC9CC 000A990C  E3 E1 00 A8 */	psq_l f31, 168(r1), 0, qr0
/* 800AC9D0 000A9910  CB E1 00 A0 */	lfd f31, 0xa0(r1)
/* 800AC9D4 000A9914  E3 C1 00 98 */	psq_l f30, 152(r1), 0, qr0
/* 800AC9D8 000A9918  CB C1 00 90 */	lfd f30, 0x90(r1)
/* 800AC9DC 000A991C  E3 A1 00 88 */	psq_l f29, 136(r1), 0, qr0
/* 800AC9E0 000A9920  CB A1 00 80 */	lfd f29, 0x80(r1)
/* 800AC9E4 000A9924  E3 81 00 78 */	psq_l f28, 120(r1), 0, qr0
/* 800AC9E8 000A9928  CB 81 00 70 */	lfd f28, 0x70(r1)
/* 800AC9EC 000A992C  E3 61 00 68 */	psq_l f27, 104(r1), 0, qr0
/* 800AC9F0 000A9930  CB 61 00 60 */	lfd f27, 0x60(r1)
/* 800AC9F4 000A9934  E3 41 00 58 */	psq_l f26, 88(r1), 0, qr0
