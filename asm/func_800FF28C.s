...
.section .text, "ax" # 800FF28C


.global func_800FF28C
func_800FF28C:
...
/* 800FF29C 000FC1DC  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 800FF2A0 000FC1E0  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 800FF2A4 000FC1E4  F3 C1 00 48 */	psq_st f30, 72(r1), 0, qr0
/* 800FF2A8 000FC1E8  DB A1 00 30 */	stfd f29, 0x30(r1)
/* 800FF2AC 000FC1EC  F3 A1 00 38 */	psq_st f29, 56(r1), 0, qr0
...
/* 800FF2D4 000FC214  48 16 8A 55 */	bl func_80267D28
/* 800FF2D8 000FC218  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800FF2DC 000FC21C  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
/* 800FF2E0 000FC220  38 63 0F 38 */	addi r3, r3, 0xf38
/* 800FF2E4 000FC224  38 9F 1D 08 */	addi r4, r31, 0x1d08
/* 800FF2E8 000FC228  4B F7 51 B9 */	bl func_800744A0
...
/* 800FF3B4 000FC2F4  4B FA 2D E5 */	bl func_800A2198
...
/* 800FF3C8 000FC308  4B FF EC 91 */	bl func_800FE058
...
/* 800FF408 000FC348  4B FC 1E D5 */	bl func_800C12DC
...
/* 800FF41C 000FC35C  48 00 00 35 */	bl func_800FF450
/* 800FF420 000FC360  38 60 00 01 */	li r3, 1
.global lbl_800FF424
lbl_800FF424:
/* 800FF424 000FC364  E3 E1 00 58 */	psq_l f31, 88(r1), 0, qr0
/* 800FF428 000FC368  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 800FF42C 000FC36C  E3 C1 00 48 */	psq_l f30, 72(r1), 0, qr0
/* 800FF430 000FC370  CB C1 00 40 */	lfd f30, 0x40(r1)
/* 800FF434 000FC374  E3 A1 00 38 */	psq_l f29, 56(r1), 0, qr0
