...
.section .text, "ax" # 800AEA70


.global func_800AEA70
func_800AEA70:
...
/* 800AEA80 000AB9C0  F3 E1 00 88 */	psq_st f31, 136(r1), 0, qr0
/* 800AEA84 000AB9C4  DB C1 00 70 */	stfd f30, 0x70(r1)
/* 800AEA88 000AB9C8  F3 C1 00 78 */	psq_st f30, 120(r1), 0, qr0
/* 800AEA8C 000AB9CC  DB A1 00 60 */	stfd f29, 0x60(r1)
/* 800AEA90 000AB9D0  F3 A1 00 68 */	psq_st f29, 104(r1), 0, qr0
/* 800AEA94 000AB9D4  DB 81 00 50 */	stfd f28, 0x50(r1)
/* 800AEA98 000AB9D8  F3 81 00 58 */	psq_st f28, 88(r1), 0, qr0
/* 800AEA9C 000AB9DC  DB 61 00 40 */	stfd f27, 0x40(r1)
/* 800AEAA0 000AB9E0  F3 61 00 48 */	psq_st f27, 72(r1), 0, qr0
/* 800AEAA4 000AB9E4  DB 41 00 30 */	stfd f26, 0x30(r1)
/* 800AEAA8 000AB9E8  F3 41 00 38 */	psq_st f26, 56(r1), 0, qr0
/* 800AEAAC 000AB9EC  39 61 00 30 */	addi r11, r1, 0x30
/* 800AEAB0 000AB9F0  48 2B 37 29 */	bl func_803621D8
...
/* 800AEB28 000ABA68  48 00 A8 19 */	bl func_800B9340
...
/* 800AEB5C 000ABA9C  48 00 A8 99 */	bl func_800B93F4
...
/* 800AECE0 000ABC20  48 03 8B B5 */	bl func_800E7894
...
/* 800AED08 000ABC48  4B FF D8 51 */	bl func_800AC558
...
/* 800AED48 000ABC88  4B FF E2 99 */	bl func_800ACFE0
.global lbl_800AED4C
lbl_800AED4C:
...
/* 800AED6C 000ABCAC  48 00 03 B1 */	bl func_800AF11C
...
/* 800AED90 000ABCD0  4B FF F0 85 */	bl func_800ADE14
/* 800AED94 000ABCD4  48 00 03 40 */	b lbl_800AF0D4
.global lbl_800AED98
lbl_800AED98:
/* 800AED98 000ABCD8  7F A3 EB 78 */	mr r3, r29
/* 800AED9C 000ABCDC  4B FF EF ED */	bl func_800ADD88
...
/* 800AEE64 000ABDA4  48 00 4A A1 */	bl func_800B3904
...
/* 800AEEB4 000ABDF4  4B FF DB 61 */	bl func_800ACA14
...
/* 800AEF4C 000ABE8C  4B FF DA C9 */	bl func_800ACA14
...
/* 800AEFC8 000ABF08  4B FF DA 4D */	bl func_800ACA14
...
/* 800AF034 000ABF74  48 27 93 F9 */	bl func_8032842C
...
/* 800AF058 000ABF98  48 27 93 D5 */	bl func_8032842C
...
/* 800AF0B8 000ABFF8  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800AF0BC 000ABFFC  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800AF0D0 000AC010  4B FC 09 55 */	bl func_8006FA24
.global lbl_800AF0D4
lbl_800AF0D4:
/* 800AF0D4 000AC014  E3 E1 00 88 */	psq_l f31, 136(r1), 0, qr0
/* 800AF0D8 000AC018  CB E1 00 80 */	lfd f31, 0x80(r1)
/* 800AF0DC 000AC01C  E3 C1 00 78 */	psq_l f30, 120(r1), 0, qr0
/* 800AF0E0 000AC020  CB C1 00 70 */	lfd f30, 0x70(r1)
/* 800AF0E4 000AC024  E3 A1 00 68 */	psq_l f29, 104(r1), 0, qr0
/* 800AF0E8 000AC028  CB A1 00 60 */	lfd f29, 0x60(r1)
/* 800AF0EC 000AC02C  E3 81 00 58 */	psq_l f28, 88(r1), 0, qr0
/* 800AF0F0 000AC030  CB 81 00 50 */	lfd f28, 0x50(r1)
/* 800AF0F4 000AC034  E3 61 00 48 */	psq_l f27, 72(r1), 0, qr0
/* 800AF0F8 000AC038  CB 61 00 40 */	lfd f27, 0x40(r1)
/* 800AF0FC 000AC03C  E3 41 00 38 */	psq_l f26, 56(r1), 0, qr0
/* 800AF100 000AC040  CB 41 00 30 */	lfd f26, 0x30(r1)
/* 800AF104 000AC044  39 61 00 30 */	addi r11, r1, 0x30
/* 800AF108 000AC048  48 2B 31 1D */	bl func_80362224
