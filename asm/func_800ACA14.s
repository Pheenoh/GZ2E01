...
.section .text, "ax" # 800ACA14


.global func_800ACA14
func_800ACA14:
...
/* 800ACA24 000A9964  F3 E1 00 68 */	psq_st f31, 104(r1), 0, qr0
/* 800ACA28 000A9968  DB C1 00 50 */	stfd f30, 0x50(r1)
/* 800ACA2C 000A996C  F3 C1 00 58 */	psq_st f30, 88(r1), 0, qr0
/* 800ACA30 000A9970  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 800ACA34 000A9974  F3 A1 00 48 */	psq_st f29, 72(r1), 0, qr0
/* 800ACA38 000A9978  DB 81 00 30 */	stfd f28, 0x30(r1)
/* 800ACA3C 000A997C  F3 81 00 38 */	psq_st f28, 56(r1), 0, qr0
/* 800ACA40 000A9980  39 61 00 30 */	addi r11, r1, 0x30
/* 800ACA44 000A9984  48 2B 57 8D */	bl func_803621D0
...
/* 800ACA80 000A99C0  4B FF FB 91 */	bl func_800AC610
...
/* 800ACAA0 000A99E0  4B FF FB 71 */	bl func_800AC610
...
/* 800ACAF0 000A9A30  48 01 32 C1 */	bl func_800BFDB0
...
/* 800ACB64 000A9AA4  48 01 32 4D */	bl func_800BFDB0
...
/* 800ACBC0 000A9B00  4B FF FB 95 */	bl func_800AC754
...
/* 800ACBE4 000A9B24  4B F6 2C 65 */	bl func_8000F848
.global lbl_800ACBE8
lbl_800ACBE8:
/* 800ACBE8 000A9B28  7F 63 DB 78 */	mr r3, r27
/* 800ACBEC 000A9B2C  7F 84 E3 78 */	mr r4, r28
/* 800ACBF0 000A9B30  4B FF D6 CD */	bl func_800AA2BC
...
/* 800ACC1C 000A9B5C  48 00 67 C9 */	bl func_800B33E4
...
/* 800ACC30 000A9B70  4B FF F9 29 */	bl func_800AC558
...
/* 800ACC44 000A9B84  4B FF F9 15 */	bl func_800AC558
...
/* 800ACC58 000A9B98  4B FF F9 01 */	bl func_800AC558
...
/* 800ACC68 000A9BA8  48 00 C5 ED */	bl func_800B9254
...
/* 800ACCBC 000A9BFC  48 00 0A 69 */	bl func_800AD724
.global lbl_800ACCC0
lbl_800ACCC0:
/* 800ACCC0 000A9C00  7F 63 DB 78 */	mr r3, r27
/* 800ACCC4 000A9C04  7F 84 E3 78 */	mr r4, r28
/* 800ACCC8 000A9C08  48 00 2C E1 */	bl func_800AF9A8
...
/* 800ACCF0 000A9C30  48 00 2C B9 */	bl func_800AF9A8
...
/* 800ACD00 000A9C40  48 00 2C A9 */	bl func_800AF9A8
.global lbl_800ACD04
lbl_800ACD04:
/* 800ACD04 000A9C44  38 60 00 01 */	li r3, 1
/* 800ACD08 000A9C48  E3 E1 00 68 */	psq_l f31, 104(r1), 0, qr0
/* 800ACD0C 000A9C4C  CB E1 00 60 */	lfd f31, 0x60(r1)
/* 800ACD10 000A9C50  E3 C1 00 58 */	psq_l f30, 88(r1), 0, qr0
/* 800ACD14 000A9C54  CB C1 00 50 */	lfd f30, 0x50(r1)
/* 800ACD18 000A9C58  E3 A1 00 48 */	psq_l f29, 72(r1), 0, qr0
/* 800ACD1C 000A9C5C  CB A1 00 40 */	lfd f29, 0x40(r1)
/* 800ACD20 000A9C60  E3 81 00 38 */	psq_l f28, 56(r1), 0, qr0
/* 800ACD24 000A9C64  CB 81 00 30 */	lfd f28, 0x30(r1)
/* 800ACD28 000A9C68  39 61 00 30 */	addi r11, r1, 0x30
/* 800ACD2C 000A9C6C  48 2B 54 F1 */	bl func_8036221C
