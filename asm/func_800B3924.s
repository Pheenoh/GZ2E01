...
.section .text, "ax" # 800B3924


.global func_800B3924
func_800B3924:
...
/* 800B3934 000B0874  F3 E1 00 58 */	psq_st f31, 88(r1), 0, qr0
/* 800B3938 000B0878  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 800B393C 000B087C  F3 C1 00 48 */	psq_st f30, 72(r1), 0, qr0
/* 800B3940 000B0880  DB A1 00 30 */	stfd f29, 0x30(r1)
/* 800B3944 000B0884  F3 A1 00 38 */	psq_st f29, 56(r1), 0, qr0
...
/* 800B39B4 000B08F4  48 07 4E 59 */	bl func_8012880C
...
/* 800B39C8 000B0908  4B FF 8B 91 */	bl func_800AC558
...
/* 800B39D8 000B0918  48 04 DF E1 */	bl func_801019B8
...
/* 800B39EC 000B092C  48 00 75 95 */	bl func_800BAF80
...
.global lbl_800B3A10
lbl_800B3A10:
/* 800B3A10 000B0950  48 00 C9 D9 */	bl func_800C03E8
...
/* 800B3A2C 000B096C  48 03 02 F1 */	bl func_800E3D1C
...
/* 800B3A3C 000B097C  48 02 93 B5 */	bl func_800DCDF0
...
/* 800B3BBC 000B0AFC  4B FF E4 1D */	bl func_800B1FD8
...
/* 800B3C54 000B0B94  48 04 DD 65 */	bl func_801019B8
...
/* 800B3CF8 000B0C38  48 1B 39 7D */	bl func_80267674
...
/* 800B3D3C 000B0C7C  48 29 36 61 */	bl func_8034739C
...
/* 800B3D4C 000B0C8C  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800B3D50 000B0C90  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
/* 800B3D54 000B0C94  38 63 0F 38 */	addi r3, r3, 0xf38
/* 800B3D58 000B0C98  38 9E 1E 4C */	addi r4, r30, 0x1e4c
/* 800B3D5C 000B0C9C  4B FC 09 05 */	bl func_80074660
...
/* 800B3EEC 000B0E2C  48 1B C8 55 */	bl func_80270740
.global lbl_800B3EF0
lbl_800B3EF0:
...
.global lbl_800B3EFC
lbl_800B3EFC:
/* 800B3EFC 000B0E3C  E3 E1 00 58 */	psq_l f31, 88(r1), 0, qr0
/* 800B3F00 000B0E40  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 800B3F04 000B0E44  E3 C1 00 48 */	psq_l f30, 72(r1), 0, qr0
/* 800B3F08 000B0E48  CB C1 00 40 */	lfd f30, 0x40(r1)
/* 800B3F0C 000B0E4C  E3 A1 00 38 */	psq_l f29, 56(r1), 0, qr0
