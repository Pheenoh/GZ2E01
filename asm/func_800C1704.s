...
.section .text, "ax" # 800C1704


.global func_800C1704
func_800C1704:
...
/* 800C1714 000BE654  F3 E1 00 B8 */	psq_st f31, 184(r1), 0, qr0
/* 800C1718 000BE658  39 61 00 B0 */	addi r11, r1, 0xb0
/* 800C171C 000BE65C  48 2A 0A B5 */	bl func_803621D0
...
.global lbl_800C1768
lbl_800C1768:
/* 800C1768 000BE6A8  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800C176C 000BE6AC  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800C17B0 000BE6F0  48 05 44 71 */	bl func_80115C20
...
/* 800C17C8 000BE708  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800C17CC 000BE70C  38 A3 61 C0 */	addi r5, r3, lbl_804061C0@l
...
/* 800C17FC 000BE73C  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800C1800 000BE740  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800C1810 000BE750  4B F8 A1 09 */	bl func_8004B918
...
.global lbl_800C1840
lbl_800C1840:
/* 800C1840 000BE780  3C 60 80 40 */	lis r3, lbl_804061C0@ha
/* 800C1844 000BE784  38 63 61 C0 */	addi r3, r3, lbl_804061C0@l
...
/* 800C1890 000BE7D0  4B F8 BC 3D */	bl func_8004D4CC
...
/* 800C1910 000BE850  48 05 EE 69 */	bl func_80120778
.global lbl_800C1914
lbl_800C1914:
...
/* 800C1964 000BE8A4  48 1A E0 19 */	bl func_8026F97C
...
/* 800C19B4 000BE8F4  48 05 ED C5 */	bl func_80120778
.global lbl_800C19B8
lbl_800C19B8:
...
/* 800C1A6C 000BE9AC  48 1A EC D5 */	bl func_80270740
...
/* 800C1AE0 000BEA20  48 1A 50 55 */	bl func_80266B34
...
/* 800C1B30 000BEA70  4B F4 A7 71 */	bl func_8000C2A0
...
/* 800C1B44 000BEA84  48 28 52 29 */	bl func_80346D6C
...
/* 800C1BBC 000BEAFC  48 1A 4F 29 */	bl func_80266AE4
...
/* 800C1BCC 000BEB0C  48 1A 4F B9 */	bl func_80266B84
...
/* 800C1CC8 000BEC08  48 0E 8F 95 */	bl func_801AAC5C
.global lbl_800C1CCC
lbl_800C1CCC:
/* 800C1CCC 000BEC0C  E3 E1 00 B8 */	psq_l f31, 184(r1), 0, qr0
/* 800C1CD0 000BEC10  CB E1 00 B0 */	lfd f31, 0xb0(r1)
/* 800C1CD4 000BEC14  39 61 00 B0 */	addi r11, r1, 0xb0
/* 800C1CD8 000BEC18  48 2A 05 45 */	bl func_8036221C
